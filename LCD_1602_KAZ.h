#ifndef _LCD_1602_KAZ
#define _LCD_1602_KAZ
...
class LCD_1602_KAZ : public LiquidCrystal_I2C {
public:
  LCD_1602_KAZ(uint8_t, uint8_t, uint8_t, uint8_t = 0);
...
extern const uint8_t rus_ya[];
//--------------------
extern const  uint8_t kaz_a[];
extern const  uint8_t kaz_A[];
extern const  uint8_t kaz_G[];
extern const  uint8_t kaz_g[];
extern const  uint8_t kaz_k[];
extern const  uint8_t kaz_K[];
extern const  uint8_t kaz_n[];
extern const  uint8_t kaz_N[];
extern const  uint8_t kaz_u[];
extern const  uint8_t kaz_U[];
extern const  uint8_t kaz_y[];
extern const  uint8_t kaz_Y[];
extern const  uint8_t kaz_h[];
extern const  uint8_t kaz_H[];
extern const  uint8_t kaz_o[];
extern const  uint8_t kaz_O[];
